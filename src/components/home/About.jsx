                                                 ...
                                                 <div   className="diagram-globe w-embed"><svg width="100%" height="100%" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <div id="w-node-_3a80f03b-0292-fcb3-69b9-bb026a4c72e8-9b251e8a" className="about-s_info_cont_item">
                                                        <div className="l1-item ">
                                                            <div className="tw-text-xl text-light">Daban Holding</div>
                                                            <div className="tw-text-2xl text-light"><strong>OUR EXPERTISE</strong></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="features-cms w-dyn-list">
                                            <div data-div-reveal="true" role="list" className="features-cms_list w-dyn-items">
                                                {features.map((feature, index) => (
                                                    <div key={index} id="w-node-_98f7fe4b-bc38-3388-67f2-767ebaad3355-9b251e8a" role="listitem" className="features-cms_list_item w-dyn-item">
