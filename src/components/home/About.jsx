...
<path d="M87.1303 15.4238H81.4674C81.6112 14.7047 81.6831 14.0215 81.6831 13.3743C81.6472 10.8575 80.5865 8.73612 78.5011 7.01027C76.3798 5.32038 73.2876 4.47544 69.2247 4.47544C59.6966 4.47544 54.2494 8.21477 52.8831 15.6934L49.4786 31.9988H43.8696L47.2741 15.6934C48.137 10.7676 50.4202 6.92038 54.1236 4.15184C57.8269 1.38329 63.1303 -0.000976562 70.0337 -0.000976562C76.3258 -0.000976562 80.8022 1.20352 83.4629 3.61251C86.0876 6.0215 87.4 8.95185 87.4 12.4035C87.4 13.3384 87.3101 14.3451 87.1303 15.4238Z" fill="currentColor"/>
                                            ...
                                            <div className="about-s_info_cont">
                                                <div className="grid _4-columns">
                                                    <div id="w-node-_3a80f03b-0292-fcb3-69b9-bb026a4c72e8-9b251e8a" className="about-s_info_cont_item">
                                                        <div className="l1-item">
                                                            <div className="l1 text-light">Daban Holding</div>
                                                            <div className="l1 text-light"><strong>Global private aviation</strong></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="w-node-_336eb7e4-f07d-2c13-2d56-8077ea13548b-9b251e8a" className="about-s_info">
                                        <div className="features-cms w-dyn-list">
                                            <div data-div-reveal="true" role="list" className="features-cms_list w-dyn-items">
                                                <div id="w-node-_98f7fe4b-bc38-3388-67f2-767ebaad3355-9b251e8a" role="listitem" className="features-cms_list_item w-dyn-item">
