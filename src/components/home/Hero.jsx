...
export default function Hero() {
  return (
    <section id="hero" className="section clip">
                    <div className="container">
                        <div className="hero_scroll-area">
                            <div className="hero-w">
                                <div className="hero-s">
                                    ...
                                    <div className="hero-s_bot b-desktop">
                                        <div className="grid">
                                            ...
                                            <div hero-s_right="" data-div-reveal="true" data-prevent-flicker="true" id="w-node-_59b46cf7-c31e-7125-08a4-0e9e21a4ddb4-9b251e8a" className="hero-s_bot_scroll">
                                                <div className="line-h on-color"></div>
                                                <div className="unit-24"></div>
                            ...
                            <div id="about" className="anchor_about"></div>
                        </div>
                    </div>
                </section>
  );
